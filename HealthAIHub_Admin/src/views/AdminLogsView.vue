<template>
  <div class="admin-logs">
    <div class="actions">
      <el-input v-model="searchQuery" placeholder="搜索管理员日志" class="search-input" @input="handleSearch">
        <template #prefix>
          <el-icon>
            <Search />
          </el-icon>
...
const selectedLogs = ref<AdminOperationLog[]>([])
...
const filteredLogs = computed(() => {
  return logs.value.filter(log =>
    ...
    log.adminId.toString().includes(searchQuery.value)
  )
})
...
const handleSelectionChange = (val: AdminOperationLog[]) => {
...
logs.value = [
  { id: 1, adminId: 1, operation: '登录系统', timestamp: '2023-05-01 10:00:00' },
  { id: 2, adminId: 2, operation: '修改用户信息', timestamp: '2023-05-01 11:30:00' },
]
